        ...
        <div class="app-wrapper">
            ...
            <div class="app-content pt-3 p-md-3 p-lg-4">
                <div class="container-xl">
                    <h1 class="app-page-title">Create a Product</h1>
                    <hr class="mb-4">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="app-card app-card-settings shadow-sm p-4">
                                ...
                                <div class="app-card-body">
                                    <form class="settings-form" action="{{route('seller.update')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="mb-3 form-group form-group--inline">
                                            ...
                                            <input name="overview" type="text" class="form-control @error('overview') is-invalid @enderror" value="{{old('overview')}}">
                                            @error('overview')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{$message}}</strong>
                                                </span>
                                        ...
                                        <div class="mb-3 form-group form-group--inline">
                                            ...
                                            <textarea style="
  height: 300px;" name="description" class="form-control @error('description') is-invalid @enderror" value="{{old('description')}}"></textarea>
                                            @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{$message}}</strong>
                                                </span>
                                        ...
                                        <div class="mb-3 form-group form-group--inline">
                                            ...
                                            <input min="1" name="count" type="number" class="form-control @error('count') is-invalid @enderror">
                                            @error('count')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{$message}}</strong>
                                                </span>
                                        ...
                                        <div class="mb-3 form-group form-group--inline">
                                            ...
                                            <input min="1" name="new_price" type="number" class="form-control @error('new_price') is-invalid @enderror" value="{{old('new_price')}}">
                                            @error('new_price')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{$message}}</strong>
                                                </span>
                                        ...
                                        <div class="mb-3 form-group form-group--inline">
                                            ...
                                            <input min="1" name="old_price" type="number" value="{{old('old_price')}}" class="form-control @error('old_price') is-invalid @enderror">
                                            @error('old_price')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{$message}}</strong>
                                                </span>
